...
(function () {
	...
	Sa.prototype = {
		...
		render: function (a, b, c) {
			...
			if (n && A)
				y === "inside" && (A = -A), d.opposite && (A = -A), h = this.getMarkPath(w, t, A, n * z, g, f), l ? l.animate({
					d: h,
					opacity: c
	...
	ha.prototype = {
		...
		setOptions: function (a) {
			this.options = D(this.defaultOptions, this.isXAxis ? {}
					 : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], D(S[this.coll], a))
		},
		...
		render: function () {
			...
			if (a.hasData() || f) {
				...
				n && o(g, function (b, c) {
					...
					if (c % 2 === 0 && b < a.max && s <= a.max - l)
						k[b] || (k[b] = new B.PlotLineOrBand(a)), y = b + l, k[b].options = {
							from: e ? ia(y) : y,
							to: e ? ia(s) : s,
							color: n
						},
			...
			if (u)
				r = a.getLinePath(u), a.axisLine ? a.axisLine.animate({
					d: r
	...
	mb.prototype = {
		...
		handleOverflow: function (a) {
			...
			if (a > f) {
				...
				A(c.chartHeight), n.hide(), this.scrollGroup.attr({
					translateY: 1
				}), this.clipHeight = 0;
			return a
		},
		scroll: function (a, b) {
			...
			e > d && (e = d);
			if (e > 0)
				b !== x && Ra(b, this.chart), this.nav.attr({
					translateX: j,
	...
	R.prototype = {
			...
			if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)
				...
				if (l && h > l) {
					...
					for (c = 0; c < h; c++)
						if (a[c] !== x && (k = {
									series: e
								}, e.pointClass.prototype.applyOptions.apply(k, [a[c]]), e.updateParallelArrays(k, c), n && q(k.name)))
							m.names[k.x] = k.name;
				Ba(r[0]) && la(14, !0);
				e.data = [];
				e.options.data = a;
		...
		drawGraph: function () {
			...
			o(c, function (c, i) {
				...
				c[2] ? k.dashstyle =
					c[2] : e && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"),
	...
	N.pie.prototype.verifyDataLabelOverflow =
	function (a) {
		var b = this.center,
		c = this.options,
		d = c.center,
