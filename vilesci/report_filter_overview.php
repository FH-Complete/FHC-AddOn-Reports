...
<html>
	...
	<body>
		<a href="report_filter_details.php" target="frame_filter_details">Neuer Filter</a>
				...
				<?php foreach ($filter->result as $filter): ?>
					<tr>
						<td class="overview-id">
							<a href="report_filter_details.php?filter_id=<?php echo $filter->filter_id ?>" target="frame_filter_details">
